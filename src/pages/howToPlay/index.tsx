        ...
        <dl>
            ...
            <dd>
                <div className={styles.imgBox}>
                    ...
                    <img src={Img03_1} width="90%" className={idx1==0?styles.active:''} alt="" />
                    <img src={Img03_2} width="90%" className={idx1==1?styles.active:''} alt="" />
                </div>
            </dd>
        </dl>
        <dl>
        ...
        <dl>
            ...
            <dd>
                <div className={styles.imgBox}>
                    ...
                    <img src={Img07_1} width="56%" className={idx2==0?styles.active:''} alt="" />
                    <img src={Img07_2} width="56%" className={idx2==1?styles.active:''} alt="" />
                </div>
