...
export default function PagerPage() {
    return (<div>
        ...
        <div className={styles.introduce}>
            <h3>what is ZClub?</h3>
            <p>ZClub is the first-ever audio-focused Web3 social app that enables everyone across the global to profit from their social networks and activities. All you need to do is to get an NFT to start, and build your social connections in the Social-Fi and Game-Fi app. </p>
            <p>We aim to make a difference. In traditional pay-to-play platforms, users are the ones who support, post and pay to use social media. But these platforms never share its money and profits, and are the only ones benefiting from their user base. However, ZClub is going to change that and become the next-gen mobile application that enable users to socialize to earn and give money/profits back to them.</p>
        </div>
        ...
        <div className={styles.tips}>
            <p>Our purpose is to be the leading Web3 audio-focused social app, enabling the mass to turn their social network into profits, and earn revenue share from social activities.</p>
        </div>
