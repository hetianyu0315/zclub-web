    ...
    axios
      ...
      .catch((e) => {
        const info = {
          ...
          '20221':
            'Did not complete comminity tasks or bot did not detect your space info',
        };
      ...
      <div className={styles.main}>
        {token === false ? (
          ...
          <>
            <div className={styles.box2}>
              ...
              {loginInfo.isDone ? (
                <div className={styles.done}>
                  ...
                  <p>
                    You’ve won a free ZClub NFT. In-app NFTs will be distributed
                    on launch day, make sure to join{' '}
                    <a href={discordJoin} target="_blank">
                      Discord
                    </a>{' '}
                    for the latest info.
                  </p>
                  {prevImg && (
                    <div className={styles.res}>
                      ...
                      <span onClick={prevImgDown}>
                        <img src={downImg} alt="" />
                      </span>
                    </div>
                  )}
                  <button onClick={goShare}>
                    Tell friends via Twitter{btnLoad2 && <i></i>}
                  </button>
                </div>
              ) : (
                <>
                  <div className={styles.bod}>
                    ...
                    <dl>
                      ...
                      <dd>
                        <p>
                          Connect your Twitter account to sync your Space data.
                        </p>
                        <ul>
                          <li>
                            <img src={follow ? itemCheck : itemNoCheck} />
                            <span>
                              Follow{' '}
                              <a
                          ...
                          <li>
                            <img
                              className={styles.verNg8}
                              src={twitter ? itemCheck : itemNoCheck}
                            />
                            <span>Connect your Twitter</span>
                            {twitter ? null : (
                              <button onClick={goVerify}>Verify Twitter</button>
                            )}
                          </li>
                        </ul>
                      </dd>
                    ...
                    <dl>
                      ...
                      <dd>
                        ...
                        <ul>
                          <li>
                            <img src={discord ? itemCheck : itemNoCheck} />
                            <span>
                              {discordTxt}{' '}
                              <a
                  ...
                  <button
                    className={twitter && discord ? '' : styles.disable}
                    onClick={Sync}
                  >
                    Sync Data to Claim NFT{btnLoad && <i></i>}
                  </button>
                  {msg ? <div className={styles.errMsg}>{msg}</div> : null}
                </>
              )}
            </div>
            {twitterInfo.twitter_user_id ? (
            ...
            {spaceInfo?.spaces?.map((item) => (
              <div className={styles.listener}>
                <div className={styles.info}>
                  <a
                    target="_blank"
                    href={`https://twitter.com/i/spaces/${item.space_id}`}
                  >
                    <i></i>
                  </a>
            ...
            <div className={styles.qa}>
              ...
              <dl>
                ...
                <dd>
                  <p>
                    A: ZClub NFTs are in-app NFTs that can be used in ZClub
                    social app to Talk2Earn. There are different types of NFTs,
                    such as SeatNFT, ChatRoomNFT, CrownNFT. Each NFTs will
                    enable able users to host events or competitions for greater
                    social connections, or level up for greater fun. Also, ZClub
                    NFT is also a credential for participation future incentive
                    events, like airdrop or giveaway.
                  </p>
                </dd>
              </dl>
              <dl>
                <dt>
                  Q2: Which blockchain is ZClub based on? What is the price of
                  NFTs?
                </dt>
                <dd>
                  <p>
                    A: ZClub is built on the Solana blockchain. Currently, all
                    twitter space users are entitled for free NFT airdrop. That
                    is to say they can claim it for free and with no gas.
                  </p>
                </dd>
              </dl>
              <dl>
                ...
                <dd>
                  <p>
                    A: Only data within 20 days can be calculated because of
                    tech issues. If your data is still incorrect, please try to
                    join a new Twitter Space, preferably with key words like
                    web3, NFT, BTC, BNB, NFTs, Binance, crypto, blockchain, AMA,
                    whitelist, dao, giveaway, airdrop, etc. Twitter space talks
                    with crypt key words are more likely to be captured by our
                    bots!
                  </p>
                  <p>
                    If you still got any suggestions or problems, please join
                    our Discord community(
                    <a href="https://discord.gg/ESJQtDmxaN" target="_blank">
                      https://discord.gg/ESJQtDmxaN
                    </a>
                    ) and ask our admin
                  </p>
                </dd>
              ...
              <dl>
                ...
                <dd>
                  <p>
                    A: It is easy to connect wallet on PC to claim NFTs.
                    However, if you want to participate in ZClub Free NFT events
                    via mobile, please follow the steps below:
                    <ul>
                      <li>
                        1. Open your SOL wallet app like Phantom or Solflare{' '}
                      </li>
                      <li>2. Go to SOL wallet app internal web portal page</li>
                      <li>
                        3. Input ZClub official site (
                        <a href="https://zclub.app/" target="_blank">
                          https://zclub.app/
                        </a>
                        )
                      </li>
                      <li>
                        4. Follow the instructions to complete all community
                        tasks to claim free NFTs
                      </li>
                    </ul>
                  </p>
                </dd>
              ...
              <dl>
                <dt>
                  Q5: I joined Space Talk today on PC. Why my space info is
                  still incorrect? What can I do to get the free airdrop?
                </dt>
                <dd>
                  <p>
                    A: ZClub Bot priorities will be given to twitter space
                    mobile users. Please try to run space talk or join a space
                    talk on mobile Twitter app, so that your space data will be
                    captured by our bot ASAP. Also, make sure to stay in the
                    space talk around 15 mins, otherwise, bot may failed to
                    capture your data.
                  </p>
                </dd>
              </dl>
              <dl>
                ...
                <dd>
                  <p>
                    A: ZClub NFTs will be distributed on the launch day (By the
                    mid of Sept until further notice). Make sure you followed
                    our twitter or joined discord community for the latest info.
                  </p>
                </dd>
              </dl>
              <dl>
                ...
                <dd>
                  <p>
                    A: Yes. ZClub NFTs can be transferred or be sold on
                    third-party platforms such as opeasan, Rarible,
                    SuperRare.etc.
                  </p>
                </dd>
              </dl>
        ...
        <div className={styles.imgBox}>
          <div className={styles.card} ref={ref}>
            <div className={styles.site}>
              Free claim ZClub NFT via https://zclub.app
            </div>
